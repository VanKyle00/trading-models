...
SYSTEM_PROMPT = (
    ...
    "the page), use them for account size and risk, never ask the user for "
    "account size or risk per trade, and confirm only the scenario: which "
    "scenario (or any tweaked number "
