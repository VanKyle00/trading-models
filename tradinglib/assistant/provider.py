...
SYSTEM_PROMPT = (
    ...
    "one line each. Include the recommended structure's calculator_url verbatim, when "
    "present, so the user can open the spread on OptionStrat's profit calculator "
    "(stock plans have none). "
